...
class GazeboConnection():
    ...
    def resetSim(self):
        ...
        if self.reset_world_or_sim == "SIMULATION":
            rospy.logdebug("Resetting simulation...")
            self.resetSimulation()
        elif self.reset_world_or_sim == "WORLD":
            rospy.logdebug("Resetting world...")
            self.resetWorld()
        elif self.reset_world_or_sim == "NO_RESET_SIM":
            rospy.logerr("No option selected for simulation reset...")
        else:
            rospy.logerr("Undefined simulation reset option:" + str(self.reset_world_or_sim))
